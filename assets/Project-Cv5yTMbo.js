import{n as e,r as t,t as n}from"./index-DSHwvKe5.js";async function r(r,i){let a=e.find(e=>e.id===i);if(!a){r.innerHTML=`<h1 style="text-align:center; padding-top: 100px;">Project not found</h1>`;return}let o=t(),s=a.title[o]||a.title.en,c=a.images.map(e=>`
