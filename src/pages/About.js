  ...
  app.innerHTML = `
    <div class="page-container about-page" style="padding-top: 120px; max-width: 1200px; margin: 0 auto; padding-left: 20px; padding-right: 20px; display: flex; flex-wrap: wrap; align-items: center; gap: 4rem;">
      ...
      <div style="flex: 1; min-width: 300px;" class="about-text-container">
         ...
         <p style="font-size: 1rem; text-transform: uppercase; letter-spacing: 2px; color: var(--accent-color); margin-bottom: 2rem;" data-i18n="elevated_identity">Elevated Interior Design</p>
         <p style="color: var(--text-color); opacity: 0.7; font-size: 1.1rem; line-height: 1.8;" data-i18n="about_text">My passion for design is rooted in the belief that every space has a story to tell...</p>
      </div>
